  ...
  return (
    <main className="max-w-xl px-6 mt-16 md:mt-20 lg:mt-32 mx-auto space-y-24">
      <section className='flex flex-col mx-auto space-y-2'>
        ...
        >
          I'm a indie hacker carve out my way to freedom.<br></br>I work on my projects, document my journey on <a href="https://twitter.com/__evanyang__/" className='underline font-semibold'>Twitter</a>, and share my story on my <span className='font-semibold'>newsletter</span>.
        </motion.p>
